...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
		...
		return false;
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Runecash Core"),
     ...
     * override -datadir in the runecash.conf file in the default data directory
     * (to be consistent with runecashd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
