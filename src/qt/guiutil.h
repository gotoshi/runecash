...
/** Utility functions used by the Runecash Qt UI.
 */
namespace GUIUtil
{
...
// Render Runecash addresses in monospace font
...
// Parse "runecash:" URI into recipient object, return true on successful parsing
