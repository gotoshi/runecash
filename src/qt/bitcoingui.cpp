                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Runecash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Runecash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and runecash: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Runecash Core"), this);
    aboutAction->setStatusTip(tr("Show information about Runecash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Runecash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Runecash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Runecash addresses"));
    ...
    openAction->setStatusTip(tr("Open a Runecash: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Runecash Core help message to get a list with possible Runecash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Runecash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Runecash network", "", count));
}
...
{
    QString strTitle = tr("Runecash Core"); // default title
