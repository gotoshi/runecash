...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Runecash server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Runecash server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Pivx features */
        {"runecash", "masternode", &masternode, true, true, false},
        {"runecash", "listmasternodes", &listmasternodes, true, true, false},
        {"runecash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"runecash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"runecash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"runecash", "masternodedebug", &masternodedebug, true, true, false},
        {"runecash", "startmasternode", &startmasternode, true, true, false},
        {"runecash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"runecash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"runecash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"runecash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"runecash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"runecash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"runecash", "mnbudget", &mnbudget, true, true, false},
        {"runecash", "preparebudget", &preparebudget, true, true, false},
        {"runecash", "submitbudget", &submitbudget, true, true, false},
        {"runecash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"runecash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"runecash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"runecash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"runecash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"runecash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"runecash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"runecash", "checkbudgets", &checkbudgets, true, true, false},
        {"runecash", "mnsync", &mnsync, true, true, false},
        {"runecash", "spork", &spork, true, true, false},
        {"runecash", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"runecash", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use runecashd, or the -server option to runecash-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> runecash-cli " + methodname + " " + args + "\n";
}
