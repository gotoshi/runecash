...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Runecash Core runecash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  runecash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded runecash transaction") + "\n" +
                               "  runecash-tx [options] -create [commands]   " + _("Create hex-encoded runecash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded runecash transaction
