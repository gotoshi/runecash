...
In order to support loading of multiple wallets in runecash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is runecash.cpp.
...
Changes to runecash.cpp
----------------------
runecash.cpp is the entry point into runecash-qt, and as such, will require some minor modifications to provide hooks for
