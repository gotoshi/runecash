...
RESOURCES += src/qt/runecash.qrc src/qt/runecash_locale.qrc

TRANSLATIONS += src/qt/locale/runecash_bg.ts \
                src/qt/locale/runecash_de.ts \
                src/qt/locale/runecash_en.ts \
                src/qt/locale/runecash_es.ts \
                src/qt/locale/runecash_fi.ts \
                src/qt/locale/runecash_fr.ts \
                src/qt/locale/runecash_it.ts \
                src/qt/locale/runecash_ja.ts \
                src/qt/locale/runecash_pl.ts \
                src/qt/locale/runecash_pt.ts \
                src/qt/locale/runecash_ru.ts \
                src/qt/locale/runecash_sk.ts \
                src/qt/locale/runecash_sv.ts \
                src/qt/locale/runecash_vi.ts \
                src/qt/locale/runecash_zh_CN.ts \
                src/qt/locale/runecash_zh_TW.ts
