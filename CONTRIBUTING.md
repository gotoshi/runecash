Contributing to Runecash Core
============================

The Runecash Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Runecash Core project, and is not to be
confused with overall Runecash Network Protocol consensus changes.

Whether a pull request is merged into Runecash Core rests with the project merge
...
Patches that change Runecash consensus rules are considerably more involved than
...
Where a patch set proposes to change the Runecash consensus, it must have been
...
The project leader is the release manager for each Runecash Core release.
